...
import 'package:jovirestaurant/src/styles/text_field_style.dart';
...
class _AppTextFieldState extends State<AppTextField> {
  ...
  Widget build(BuildContext context) {
      if (widget.isIOS){
      return Padding(
        padding: EdgeInsets.symmetric(horizontal: TextFieldStyles.textFieldHorizontal, vertical: TextFieldStyles.textBoxVertical),
        child: Column(
          children: <Widget>[
            CupertinoTextField(  
